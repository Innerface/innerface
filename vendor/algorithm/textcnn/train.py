...
#load word2vec
# model = gensim.models.Word2Vec.load("E:/WWW/intelligent-cs/vendor/dataset/wordVec/baike_1.jieba.split.model")
...
print('x', x.shape)
print('vocabulary', len(vocab_processor.vocabulary_))

# x = []
# for text in x_text:
#     texts = text.split(" ")
#     cnt = len(texts)
#     txt_vec = np.zeros(200)
#     for txt in texts:
#         if txt in model:
#             # print('word', model[txt].shape)
#             txt_vec += model[txt]
#     txt_vec = txt_vec * 1 / cnt
#     x.append(txt_vec)
# x = np.array(x)
# # print('x', x)
...
print('shuffle_indices' ,shuffle_indices.shape)
...
with tf.Graph().as_default() as g2:
    ...
    with sess.as_default():
        ...
        def train_step(x_batch, y_batch):
            ...
            # print('cnn-H', sess.run(cnn.scores, feed_dict))
